/*class DemoValues {
  ...
  static const String postImage = "assets/images/leaf.jpg";
  static const String userName = "Marwan Agmy";
  static const String userEmail = "marwanagmy@gmail.com";
  static const String postTime = "10 Aug, 2024";
  static const String postTitle = "Maple Trees";
  static const String postSummary =
...
class DemoValues {
  static final List<UserModel> users = [
    ...
    UserModel(
      id: "2",
      name: "Sendrila",
      email: "Sendrila@gmail.com",
      image: "assets/images/Sendrila.png",
      followers: 456,
...
Repudiandae sint soluta ullam sunt eos id laborum. Veniam molestiae ipsa odit soluta in rerum amet. Deserunt rerum vero est eaque voluptas aspernatur ut voluptatem. Sint sed enim.""";
  ...
  static final List<PostModel> posts = [
    PostModel(
      ...
      postTime: DateTime(2024, 11, 27, 7, 36),
      reacts: 123,
      views: 456,
      comments: _comments,
    ),
    PostModel(
      ...
      body: _body,
      imageURL: "assets/images/oka_tree.jpg",
      postTime: DateTime(2001, 1, 25),
      reacts: 321,
      views: 654,
      comments: _comments,
    ),
    PostModel(
      ...
      body: _body * 2,
      imageURL: "assets/images/mango_tree.jpg",
      postTime: DateTime(2015, 10, 17),
      reacts: 213,
      views: 546,
      comments: _comments,
    ),
